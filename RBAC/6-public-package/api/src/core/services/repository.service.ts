import { Repository, getManager, InsertResult } from 'typeorm';
import { XQuery, XId, XResultList, XIdType, XSafeAny } from '../interfaces';
...
> {
  ...
  async post(entity: XSafeAny): Promise<boolean> {
    return await this.repository.hasId(entity);
  }
